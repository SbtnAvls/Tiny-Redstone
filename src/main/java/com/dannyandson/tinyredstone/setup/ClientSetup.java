...
@EventBusSubscriber(modid = TinyRedstone.MODID, value = Dist.CLIENT, bus = EventBusSubscriber.Bus.MOD)
public class ClientSetup {

    public static final ResourceLocation TRANSPARENT_TEXTURE_LOC = ResourceLocation.fromNamespaceAndPath(TinyRedstone.MODID, "textures/gui/transparent.png");
    ...
    public static void onRegisterMenuScreens(RegisterMenuScreensEvent event) {
        event.register(Registration.CUTTER_MENU_TYPE.get(), ChopperScreen::new);
    }
    ...
    public static void onRegisterClientExtensions(RegisterClientExtensionsEvent event) {
        // Register BEWLR for PanelItem
        event.registerItem(new IClientItemExtensions() {
            private PanelItemRenderer renderer;
        ...
        }, Registration.REDSTONE_PANEL_ITEM.get());

        // Register BEWLR for TinyBlockItems
        event.registerItem(new IClientItemExtensions() {
            private TinyBlockItemRenderer renderer;
        ...
        }, Registration.TINY_SOLID_BLOCK.get(), Registration.TINY_TRANSPARENT_BLOCK.get());

        // Register BEWLR for PanelCoverItems
        event.registerItem(new IClientItemExtensions() {
            private PanelCoverItemRenderer renderer;
        ...
        }, Registration.PANEL_COVER_DARK.get(), Registration.PANEL_COVER_LIGHT.get());
    }
}
